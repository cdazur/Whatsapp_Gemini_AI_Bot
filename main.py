...
prompt = load_prompt("prompt.txt")  # Load the prompt from the file

convo = model.start_chat(history=[
])

convo.send_message(prompt.format(bot_name=bot_name, name=name)) # Use .format to insert variables
